...
# secret store. The wildcard overrides point at the as-built LXC 100 cert
# path (/etc/nginx/pickle-certs) — the code defaults reference /etc/nginx/certs/origin, which does not
